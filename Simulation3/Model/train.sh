...
#        time ./bin/eng_OP_focused_reading_blis -seed ${i} -trained_weights ./TrainedWeights_New/Oral_Weight_${k}_v${i} -epsilon 0.05 -iteration 1000000

#        echo "OS focused training: version=${i}, proficiency level=${k}"
#        time ./bin/eng_OS_focused_reading_blis -seed ${i} -trained_weights ./TrainedWeights_New/Oral_Weight_${k}_v${i} -epsilon 0.05 -iteration 1000000
